export const vaultAbi = [
  {
    type: "constructor",
    inputs: [
      { name: "wrappedNative", type: "address", internalType: "address" },
    ],
  ...
  },
  {
    ...
    inputs: [
      { name: "vulnerabilityURI", type: "string", internalType: "string" },
    ],
