export const registryAbi = [
  {
    ...
    inputs: [
      ...
      { name: "wNative", type: "address", internalType: "contract WETH" },
    ],
  ...
  },
  {
    ...
    outputs: [
      { name: "auditRequest", type: "uint256", internalType: "uint256" },
    ],
    stateMutability: "view",
  },
  {
  ...
  },
  {
    ...
    name: "requestAudit",
    inputs: [
      { name: "auditRequestId", type: "uint256", internalType: "uint256" },
    ],
    outputs: [
      { name: "functionsRequestId", type: "bytes32", internalType: "bytes32" },
      { name: "tokenId", type: "uint256", internalType: "uint256" },
    ],
    stateMutability: "payable",
  },
  {
    ...
    name: "requests",
    inputs: [
      { name: "functionsRequest", type: "bytes32", internalType: "bytes32" },
    ],
    outputs: [
      { name: "owner", type: "address", internalType: "address" },
      { name: "tokenId", type: "uint256", internalType: "uint256" },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "error", type: "string", indexed: false, internalType: "string" },
    ],
    anonymous: false,
  },
  {
    type: "event",
    name: "AuditRequestSuccess",
    inputs: [
      {
        name: "requestId",
        type: "bytes32",
  ...
  { type: "error", name: "InvalidArgsLength", inputs: [] },
  ...
  { type: "error", name: "PriceFetchFailed", inputs: [] },
] as const;
